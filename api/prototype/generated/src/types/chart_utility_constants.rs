...
pub struct ChartUtilityConstants {
    ...
    custom_tag_selected_overlay_tint: Option<crate::types::Color>,
    default_color_by_type: Option<std::collections::HashMap<String, crate::types::Color>>,
    ...
    default_friendly_color_by_type: Option<std::collections::HashMap<String, crate::types::Color>>,
