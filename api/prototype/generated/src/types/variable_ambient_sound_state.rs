...
pub struct VariableAmbientSoundState {
    ...
    layers_properties:
        Option<crate::vec::Vec<crate::types::VariableAmbientSoundLayerStateProperties>>,
    name: String,
    next_state: Option<String>,
    next_state_layers_finished_layers: Option<crate::vec::Vec<String>>,
    next_state_trigger: Option<crate::types::VariableAmbientSoundNextStateTrigger>,
    next_states: Option<crate::vec::Vec<crate::types::VariableAmbientSoundNextStateItem>>,
